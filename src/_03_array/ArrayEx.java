...
public class ArrayEx {
    ...
    public static void main(String[] args){
        ...
        //
        int[] intArray = {12, 43, 63, 17, 29};
        System.out.println("intArray [0] : " + intArray[0]);
        System.out.println("intArray [1] : " + intArray[1]);
        System.out.println("intArray [2] : " + intArray[2]);
        System.out.println(intArray);// 참조값

        intArray[1] = 24;//인덱스 1번 원소 값을 변경
        System.out.println("intArray [1] : " + intArray[1]);
        ...
        System.out.println(charArray);// 참조값
        ...
        int[] array2 = {1,2,3};
        int[] array3 = {4,2,3};
        System.out.println("array vs array2 : " + Arrays.equals(array1, array2));// true
        System.out.println("array vs array3 : " + Arrays.equals(array1, array3));// false

        System.out.println("array vs array2 : " + (array1 == array2));// false
        System.out.println("array vs array3 : " + (array1 == array3));// false

        //deepEquals(arr1, arr2)
        int[][] deepArray1 = {{1,2}, {3,4}};
        int[][] deepArray2 = {{1,2}, {3,4}};
        int[][] deepArray3 = {{1,2}, {3,5}};
        System.out.println("deepArray1 vs deepArray2 : " + Arrays.deepEquals(deepArray1, deepArray2));
        System.out.println("deepArray1 vs deepArray2 : " + Arrays.deepEquals(deepArray1, deepArray3));
